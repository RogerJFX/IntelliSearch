...
import de.crazything.app.test.ml.Slogan
...
object DataProvider {
  ...
  val wrapperFnSlogan: Array[String] => Slogan = arr => Slogan(arr(0).toInt, arr(1), arr(2), arr(3), arr(4), arr(5))
  ...
  def readSlogans(): Seq[Slogan] =
    doReadResource("/ml/slogans.txt", wrapperFnSlogan)
